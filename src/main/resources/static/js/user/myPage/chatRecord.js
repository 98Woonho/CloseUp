...
function clickChatLi(chat) {
    ...
    stomp.connect({}, function () {
        ...
        stomp.subscribe("/sub/chat/room/" + chat.dataset.id, function (messageInfo) {
    ...
    const expertNickname = chat.querySelector('.nickname').innerText;

    // 전문가 정보 가져오기
    axios.get(`/expert/${expertNickname}`)
        .then(res => {
    ...
    axios.get(`/expert/detail/${expertNickname}/expertise`)
        .then(res => {
